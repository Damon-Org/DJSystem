...
export default class DJUser {
    ...
    revokeDelay(timeout) {
        ...
        try {
            this._revokeMessage = this.member.send(`${this.member}, you've left the voice channel, if you do not rejoin within ${timeout / 12e4} minute your role as DJ will be revoked and given to someone else.`);
        } catch (e) {
